        ...
        <div class="content">
            ...
            <div class="input-wrapper">
                ...
                <div class="input-money clearfix">
                    ...
                    <button class="pull-right" @click="allturnout">全部转入</button></div>
                <div class="clearfix tip">
                    <p class="tip-msg">{{msg}}</p>
                    <p class="pull-right">1元=1嘉币</p></div>
            </div>
...
//                    console.log(res);
            ...
            jbturnout(){
                ...
                this.$http.post(Api+"/financial/recharge/",{num:num}).then(function(response){
                    var res = response.data;
                    this.msg=res.detail;
                    if(res.success==0){
                        this.show=true;
...
<style  scoped lang="scss" rel="stylesheet/scss">
  ...
  .input-wrapper{
    ...
    button{@include sc(.3rem, #409fff);background-color: #fff;margin-top: .4rem;}
